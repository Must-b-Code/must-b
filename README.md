...
> **Built on OpenClaw (MIT).** Must-b's
> multi-channel gateway core is derived from the OpenClaw project (formerly
> *clawd* / *Clawdbot* / *Moltbot*), Copyright (c) 2025 Peter Steinberger, used
> under the MIT License. See [`NOTICE`](NOTICE) and [`THIRD-PARTY-LICENSES.md`](THIRD-PARTY-LICENSES.md).
> Must-b's own first-party code is proprietary — see [`LICENSE`](LICENSE).
